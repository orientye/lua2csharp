...
public class IrReturnMultiDemoMain {

    public static void main(String[] args) throws Exception {
        String luaPath = "./src/test/examples/ReturnMulti.lua";
        String csPath = "./src/test/examples/ReturnMulti.cs";
        ...
        if (csResult.equals(csFileContent)) {
            System.out.println("ReturnMulti.lua IR transform success");
        } else {
            System.err.println("ReturnMulti.lua IR transform failed!!!");
        }
    }
